class PostHandleAddCharCmd
  ...
  def handle
    ...
    @server.show_flash :notice, "Your link code has been generated.  This code can only be used once.  Log in to your character on the game and run this command to link the character to your handle:  handle/link #{handle.name}=#{code}"
